// frontend/src/pages/Home.jsx - ПОЛНОСТЬЮ ИСПРАВЛЕННАЯ ВЕРСИЯ
...
export default function Home({ city = "Москва", user, onNavigateToCategory }) {
  ...
  // ИСПРАВЛЕНО: клик по категории - переходим на отдельную страницу
  const handleCategoryClick = useCallback((category) => {
    console.log("Переход к категории:", category.slug);
    // Если есть функция навигации к категории, используем её
    if (onNavigateToCategory) {
      onNavigateToCategory(category);
    } else {
      // Пока что показываем как раньше, но в будущем сделаем отдельную страницу
      alert(`Категория: ${category.name}\nТоваров: ${category.products_count}\n\n(Страница категории в разработке)`);
    }
  ...
  return (
    <div className="home-page">
      ...
      {/* ИСПРАВЛЕНО: убран JSX атрибут, добавлен правильный CSS */}
      <style>{`
        .home-page {
