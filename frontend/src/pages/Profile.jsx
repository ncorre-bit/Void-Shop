// frontend/src/pages/Profile.jsx - ИСПРАВЛЕННАЯ ВЕРСИЯ
...
export default function Profile({ city, setCity, user, telegramUser }) {
  ...
  function handleOperationsHistory() {
    alert("История операций - в разработке\nЗдесь будут показаны все ваши пополнения и покупки");
  }
      ...
      <div className="profile-card">
        ...
        <div className="quick-actions">
          <button className="action-btn primary" onClick={() => setShowBalanceModal(true)}>
            ...
            <span className="action-description">Пополните свой баланс</span>
          </button>
