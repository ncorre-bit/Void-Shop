// frontend/src/components/Header.jsx - ИСПРАВЛЕННАЯ ТЕМНАЯ ТЕМА
  ...
  return (
    <header className="app-header">
      ...
      <style jsx>{`
        ...
        /* ИСПРАВЛЕНО: состояние active для темной темы */
        ...
        /* ИСПРАВЛЕНО: активное состояние кнопок в темной теме */
        ...
        /* ИСПРАВЛЕНО: активное состояние меню в темной теме */
        :global(.theme-dark) .menu-button:active {
          background: rgba(30, 39, 46, 0.9);
          color: var(--accent);
          border-color: var(--accent);
        }
